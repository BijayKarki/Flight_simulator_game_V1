...
def create_game(screen_name, co2_budget, location):
    ...
    # print(str(unique_id)[:8])  # converting it into a string and slicing only 8 characters
...
game_id = create_game('test55', 10000, 'EFHK')

print(game_id)

update_game_by_id(game_id, 5000, 'EECL')
